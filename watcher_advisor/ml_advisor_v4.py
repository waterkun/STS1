#!/usr/bin/env python3
"""
Watcher ML Advisor V4 - A20 胜局专用 Transformer
...
Usage:
  ...
  python -m watcher_advisor.ml_advisor_v4 card \\
...
def main():
    parser = argparse.ArgumentParser(description="观者 ML 决策顾问 V4 (A20 胜局 Transformer)")
    ...
    if args.command == "card":
        ...
        preds = predict_all_boss_relic(options, args.act, hp_pct,
                                       deck, relics, db, vocab, v4_models)
        print(f"\n=== 观者 V4 Transformer 决策建议 (Boss 遗物选择) ===")
