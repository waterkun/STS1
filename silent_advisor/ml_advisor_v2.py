#!/usr/bin/env python3
"""
Silent ML Advisor V2 - 三种新模型解决区分度不足问题
...
Usage:
  python silent_advisor/ml_advisor_v2.py train
  python silent_advisor/ml_advisor_v2.py card \
...
_ATTACK_CARDS = {
    "Strike_G", "Neutralize", "Dagger Spray", "Dagger Throw",
    "Flying Knee", "Poisoned Stab", "Quick Slash", "Slice",
    "Sneaky Strike", "Sucker Punch", "Bane", "Choke",
    "Dash", "Die Die Die", "Eviscerate", "Finisher",
    "Flechettes", "Glass Knife", "Grand Finale", "Heel Hook",
    "Masterful Stab", "Predator", "Riddle with Holes",
    "Skewer", "Backstab", "All-Out Attack", "Unload",
}
_SKILL_CARDS = {
    "Defend_G", "Survivor", "Acrobatics", "Backflip",
    "Blade Dance", "Cloak and Dagger", "Deadly Poison",
    "Deflect", "Dodge and Roll", "Outmaneuver", "Prepared",
    "Piercing Wail", "Setup", "Leg Sweep", "Escape Plan",
    "Bouncing Flask", "Concentrate", "Crippling Cloud",
    "Distraction", "Expertise", "Malaise", "Phantasmal Killer",
    "Reflex", "Tactician", "Terror", "Adrenaline",
    "Bullet Time", "Burst", "Calculated Gamble",
    "Catalyst", "Doppelganger", "Night Terror", "Storm of Steel",
    "Blur",
}
_POWER_CARDS = {
    "Accuracy", "Caltrops", "Footwork", "Infinite Blades",
    "Noxious Fumes", "Well-Laid Plans", "A Thousand Cuts",
    "After Image", "Corpse Explosion", "Envenom",
    "Tools of the Trade", "Wraith Form",
}


_BASIC_CARDS = {"Strike_G", "Defend_G"}
...
_POISON_GENERATORS = {"Deadly Poison", "Poisoned Stab", "Noxious Fumes", "Bouncing Flask", "Crippling Cloud", "Corpse Explosion", "Envenom", "Catalyst"}
_POISON_SCALERS = {"Catalyst", "Envenom", "Corpse Explosion", "Bouncing Flask"}
_DISCARD_PRODUCERS = {"Survivor", "Prepared", "Dagger Throw", "Acrobatics", "Calculated Gamble", "Tools of the Trade", "Tactician", "Reflex", "Sneaky Strike"}
_DISCARD_SYNERGY = {"Tactician", "Reflex", "Sneaky Strike", "Concentrate", "Calculated Gamble"}
_BLOCK_GENERATORS = {"Defend_G", "Dodge and Roll", "Leg Sweep", "Blur", "Escape Plan", "Cloak and Dagger", "Backflip", "Deflect"}
_BLOCK_SCALERS = {"Footwork", "After Image", "Blur", "Wraith Form", "Malaise"}
_DRAW_ENGINES = {"Backflip", "Acrobatics", "Adrenaline", "Calculated Gamble", "Tools of the Trade", "Well-Laid Plans"}
_SHIV_GENERATORS = {"Blade Dance", "Cloak and Dagger", "Infinite Blades", "Storm of Steel", "Accuracy"}
_SHIV_SCALERS = {"Accuracy", "After Image", "Envenom", "A Thousand Cuts"}
_WEAK_APPLIERS = {"Neutralize", "Leg Sweep", "Sucker Punch", "Crippling Cloud", "Malaise"}
_RETAIN = {"Well-Laid Plans", "Equilibrium", "Runic Pyramid"}
_ENERGY_GENERATORS = {"Adrenaline", "Concentrate", "Tactician", "Outmaneuver"}

_SYNERGY_PAIRS = [
    (_POISON_GENERATORS, _POISON_SCALERS, "poison"),
    (_DISCARD_PRODUCERS, _DISCARD_SYNERGY, "discard"),
    (_BLOCK_GENERATORS, _BLOCK_SCALERS, "block_scale"),
    ({"Footwork"}, _BLOCK_GENERATORS, "footwork_block"),
    (_SHIV_GENERATORS, _SHIV_SCALERS, "shiv"),
    ({"Accuracy"}, _SHIV_GENERATORS, "accuracy_shiv"),
    ({"Envenom"}, _SHIV_GENERATORS | {"Blade Dance"}, "envenom_shiv"),
    (_DRAW_ENGINES, {"Storm of Steel", "Catalyst", "Adrenaline"}, "draw_payoff"),
    (_WEAK_APPLIERS, {"Eviscerate", "Glass Knife", "Grand Finale"}, "weak_combo"),
    (_ENERGY_GENERATORS, {"Burst", "Wraith Form", "Catalyst"}, "energy_payoff"),
    ({"Noxious Fumes"}, {"Corpse Explosion", "The Specimen"}, "fumes_combo"),
]

_ARCHETYPES = {
    "poison": _POISON_GENERATORS | _POISON_SCALERS,
    "discard": _DISCARD_PRODUCERS | _DISCARD_SYNERGY,
    "shiv": _SHIV_GENERATORS | _SHIV_SCALERS,
...
_KEYWORD_GROUPS = [
    ...
    _DRAW_ENGINES, _SHIV_GENERATORS,
    _SHIV_SCALERS, _WEAK_APPLIERS,
    _RETAIN, _ENERGY_GENERATORS,
]
...
_RELIC_CARD_SYNERGIES = [
    ("Dead Branch", {"Survivor", "Calculated Gamble", "Acrobatics", "Tactician", "Reflex", "Expertise", "Concentrate"}, "dead_branch_discard"),
    ("Snecko Eye", {"Wraith Form", "Bullet Time", "Corpse Explosion", "A Thousand Cuts", "Doppelganger", "Skewer"}, "snecko_high_cost"),
    ("Shuriken", {"Blade Dance", "Cloak and Dagger", "Infinite Blades", "Flechettes", "Riddle with Holes"}, "shuriken_multi_atk"),
    ("Kunai", {"Blade Dance", "Cloak and Dagger", "Infinite Blades", "Flechettes", "Riddle with Holes"}, "kunai_multi_atk"),
    ("Ornamental Fan", _ATTACK_CARDS, "ornamental_fan_attacks"),
    ("Pen Nib", {"Eviscerate", "Glass Knife", "Die Die Die", "Skewer", "Grand Finale"}, "pen_nib_high_dmg"),
    ("After Image", _SKILL_CARDS | _ATTACK_CARDS, "after_image_cards"),
    ("Twisted Funnel", _POISON_GENERATORS, "twisted_funnel_poison"),
    ("The Specimen", {"Noxious Fumes", "Corpse Explosion", "Deadly Poison", "Bouncing Flask"}, "specimen_poison"),
]
...
def main():
    parser = argparse.ArgumentParser(
        description="静默猎人 ML 决策顾问 V2 (LambdaMART / LogReg / CWR-Delta)",
    )
