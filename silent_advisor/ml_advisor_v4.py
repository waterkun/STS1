#!/usr/bin/env python3
"""
Silent ML Advisor V4 - A20 胜局专用 Transformer
...
Usage:
  ...
  python -m silent_advisor.ml_advisor_v4 card \\
...
def main():
    parser = argparse.ArgumentParser(description="静默猎手 ML 决策顾问 V4 (A20 胜局 Transformer)")
